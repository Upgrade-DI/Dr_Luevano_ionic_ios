...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/PushwooshInboxUIXCFramework/PushwooshInboxUI.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/PushwooshXCFramework/Core/PushwooshFramework.framework"
fi
